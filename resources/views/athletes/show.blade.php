<x-layouts.app :title="$athlete->first_name . ' ' . $athlete->last_name . ' - CA Sion - Statistiques'">
            ...
            <div class="md:col-span-4">
                ...
                <table class="table table-xs w-full">
                    <tbody>
                        ...
                        <tr>
                            <td class="font-medium px-0">{{ $pb->discipline->name_fr }}</td>
                ...
                <table class="table table-xs table-zebra w-full">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="font-medium px-1">{{ $result->discipline->name_fr }}</td>
